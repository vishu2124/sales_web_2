...
<br><br>
	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 icon"></div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 icon" id="backlogin"><h2><font class=text-success style=
			"margin:10%">
			Login Client</font>
		</h3>
			<form method="POST" action="<?php echo htmlspecialchars("managementpage.php");?>">
				...
				<input type="submit" name="login" value="Login_client" class="btn btn-primary">
